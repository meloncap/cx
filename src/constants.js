// export const TOKENADDRESS = '0x061A8FC24C26273dC46dcAA57e1C4FA637189D10';

export const TOKENADDRESS = '0x2f4FC16308Be09e7611a047B9576881Eb5298dD6';
export const coinMarketCapUrl = `https://coinmarketcap.com/currencies/snow-burn/`;
export const coinGeckoUrl = `https://www.coingecko.com/en/coins/snow-burn`;
export const twitterUrl = `https://twitter.com/SnowBurnAVAX`;
export const telegramUrl = `https://t.me/SnowBurnAVAX`;
export const traderJoeUrl = `https://traderjoexyz.com/#/trade?outputCurrency=${TOKENADDRESS}`;
export const snowtraceUrl = `https://snowtrace.io/token/${TOKENADDRESS}`;
export const dexscreenerUrl = `https://dexscreener.com/avalanche/${TOKENADDRESS}`;
export const githubUrl = 'https://github.com/Snow-protocol';
export const mediumUrl = 'https://medium.com/@snowprotocol';
